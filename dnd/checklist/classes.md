...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 448-449
**Foundry id:** `5nxfoXZ5KpOFYpLm`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 26-32
**Foundry id:** `JcaqlAawhf14q1lq`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 118-123
**Foundry id:** `uynVENa0deVdmf53`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 8-14
**Foundry id:** `GK6rAenFfgJNNJCX`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 449
**Foundry id:** `j9B52zPw8AwNqYsk`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Race Guide (PZO1131) p. 8-13
**Foundry id:** `W3EjUgYLJ1D9qDKw`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 31-34
**Foundry id:** `g3pq7xWWdUVYw6ai`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 34-38
**Foundry id:** `6GjOjO6r3R06fLwE`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 15-22
**Foundry id:** `E27lMw9YNOAjS009`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 23-25
**Foundry id:** `iDlGMIezGuqqt8Us`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 32-37
**Foundry id:** `u1ed3H9xtYQXTP5v`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 38-48
**Foundry id:** `SjFqQceVeVBzBwgn`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 48-54
**Foundry id:** `7eZQP0MzeO2svmVF`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 450
**Foundry id:** `H0iUHrBW5tqrL9Zu`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 55-56
**Foundry id:** `WLqBCT5DqmGAx8Wd`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary (PZO1118) p. 9-12
**Foundry id:** `jOUMbWoFZHQlAMpJ`
...
>
> **Starting Wealth**: The gunslinger begins with her starting firearm.
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 26-29
**Foundry id:** `Immo2BuSe5WGdRW9`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 38-42
**Foundry id:** `Fv3FbmXptuDRiL5y`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 30-34
**Foundry id:** `s27zdYVFenYBVtfu`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 10-29
**Foundry id:** `vh9TZBE6BRu9sCfE`
...
**Tags:** —
**Prerequisites:** —
**Source:** Ultimate Magic (PZO1117) p. 9-13
**Foundry id:** `xZLcyrEKYZoJPS2k`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 30-38
**Foundry id:** `xtRbNEKYYq4cRiwI`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 38-45
**Foundry id:** `fLU25FvuRWMCSxPP`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Race Guide (PZO1131) p. 14-19
**Foundry id:** `5mQIOIw4hDhlREPo`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 56-60
**Foundry id:** `W8dxwZ1CZiwLKsqr`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary (PZO1118) p. 13-17
**Foundry id:** `DGDOm05afSJj454X`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 46-59
**Foundry id:** `5uUzVl0gLZ23vY96`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 42-54
**Foundry id:** `5S0u8yFcP861wgd1`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 60-64
**Foundry id:** `ohptcds1d5oG6Bjh`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 60-71
**Foundry id:** `0ahLHNR2864mih3n`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 64-67
**Foundry id:** `w3wjj6s3N69BsMc3`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Race Guide (PZO1131) p. 20-24
**Foundry id:** `5tsZI6zk29yX1ckA`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 67-70
**Foundry id:** `24b0LaabeAlUx5gN`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary (PZO1118) p. 18-22
**Foundry id:** `yM8xfml1Xrccfwux`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 35-48
**Foundry id:** `jMi3GBtvdG0WhH8L`
...
**Tags:** —
**Prerequisites:** —
**Source:** Occult Adventures (PZO1140) p. 26-31
**Foundry id:** `16mfrGi2UHTsME4W`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 49-52
**Foundry id:** `G2SqFdNKFxbujzbH`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 53-55
**Foundry id:** `cOY76lMUkupH534m`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 70-77
**Foundry id:** `AoWSbnuTSGIxmv61`
...
**Tags:** —
**Prerequisites:** —
**Source:** Bestiary 4 (PZO1132) p. 72-83
**Foundry id:** `iYAQs7zjFbgcmect`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Race Guide (PZO1131) p. 25-39
**Foundry id:** `5iDrtRQMuIhLymUA`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 54-64
**Foundry id:** `BrnHPJ2EVSQSyNQ8`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 56-59
**Foundry id:** `Q3rbWILULpQfpjjZ`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Class Guide (PZO1129) p. 60-68
**Foundry id:** `KgxFsHNv0g1GbvmS`
...
**Tags:** —
**Prerequisites:** —
**Source:** Advanced Player's Guide (PZO1115) p. 65-71
**Foundry id:** `RC4D4WFT5kRKkdqp`
...
**Tags:** —
**Prerequisites:** —
**Source:** Core Rulebook (PZO1110) p. 77-83
**Foundry id:** `0c4lYDywj6bQ0i8r`
