...
CORE_MECHANICS: dict[str, Entry] = {
    ...
    "combat.combat_maneuver_basic":  (IMPLEMENTED,    "_resolve_maneuver: d20 + actor.cmb vs target.cmd(context={'maneuver': kind}); nat 1 always fails / nat 20 always succeeds per RAW; enables Stability and similar qualified CMD bonuses"),
