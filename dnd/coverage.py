...
CONDITIONS: dict[str, Entry] = {
    ...
    "disabled":        (PARTIAL,        "validate_turn restricts to one move OR standard (no full-round); the 1 HP self-damage on standard actions isn't modeled"),
    ...
    "helpless":        (PARTIAL,         "denies Dex (sneak attack qualifies); auto-implied by unconscious/sleeping/paralyzed/petrified via _IMPLIES_HELPLESS cascade; coup-de-grace not modeled"),
